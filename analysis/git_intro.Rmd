...
[available here]: https://github.com/lillian-aoki/workshop_website/blob/master/slides/03_version_control.pdf
...
One of the useful basic commands is `status` which will give you the status of  
your git repo. 
