...
Remember, the first two lines have been added to the previous commit, so they are captured by Git. But the third line you just added is a new modifcation, and has not been added (staged) and committed yet. 
...
Working in either the command line or a Git client:
 ...
 6. Use the alternative tool (command line or client) to commit the new changes and check the status of the repo
