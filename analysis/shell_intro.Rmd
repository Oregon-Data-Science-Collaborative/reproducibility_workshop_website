...
`$ mkdir figs` creates a directory `figs` within the current directory. If the folder  
`figs` already exists, then you can run 
`$ mkdir figs/high-res/` to create `high-res` inside `figs`.
